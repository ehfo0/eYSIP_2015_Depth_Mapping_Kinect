...
def regular_movement(z):
    ...
    middlearea = z[200:479,200:439]
    middleval = middlearea.mean()
    leftarea = z[0:479,0:319]
    rightarea = z[0:479,320:639]
    leftval = CountZeros(leftarea,160,255)
    rightval = CountZeros(rightarea,160,255)
    middleob = CountZeros(middlearea,150,255)
    lefttop = z[0:100,0:100]
    lefttopmean = lefttop.mean()
    if eli == 0:
        if lefttopmean > 250:
            ser.write("\x34")
            time.sleep(0.1)

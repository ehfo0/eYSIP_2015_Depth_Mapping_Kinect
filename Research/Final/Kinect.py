...
def take_right():
    ...
    * Example Call:	take_right()
    """
    while True:
        global_depth_map_right = get_depth()
        back_movement(global_depth_map_right)
        middlearea = global_depth_map_right[200:479, 200:439]
...
def take_left():
    ...
    * Example Call:	take_left()
    """
    while True:
        global_depth_map_left = get_depth()
        back_movement(global_depth_map_left)
        middlearea = global_depth_map_left[200:479, 200:439]
        middleval = middlearea.mean()
...
def take_right_near():
    ...
    * Example Call:	take_right_near()
    """
    while True:
        global_depth_map_near = get_depth()
        back_movement(global_depth_map_near)
        middlearea = global_depth_map_near[0:479, 240:399]
        contoursrightnear = contours_return(global_depth_map_near, -10)
        contoursleftnear = contours_return(global_depth_map_near, 10)
...
def stuck_pos_movement():
    ...
    * Example Call:	stuck_pos_movement()
    """
    global_depth_map_pos = get_depth()
    leftarea = global_depth_map_pos[0:479, 0:200]
    rightarea = global_depth_map_pos[0:479, 439:639]
...
def search_wall(directionwall):
    ...
    * Example Call:	search_wall(0)
    ...
    if directionwall == 0:
        while True:
            global_depth_map_wall = get_depth()
            area = global_depth_map_wall[0:479, 0:319]
            contoursrightwall = contours_return(global_depth_map_wall, -10)
            contoursleftwall = contours_return(global_depth_map_wall, 10)
        ...
        while True:
            global_depth_map_wall = get_depth()
            area = global_depth_map_wall[0:479, 320:639]
            contoursrightwall = contours_return(global_depth_map_wall, -10)
            contoursleftwall = contours_return(global_depth_map_wall, 10)
            door_detection(contoursrightwall, contoursleftwall)
            SERIALDATA.write("\x30")
